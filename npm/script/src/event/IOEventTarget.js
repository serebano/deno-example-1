...
exports.IOEventTarget = exports.IOEventFactory = void 0;
// deno-lint-ignore-file no-unused-vars no-explicit-any
const TypedEventTarget_js_1 = require("./TypedEventTarget.js");
const IOEvent_js_1 = require("./IOEvent.js");
class IOEventFactory {
    open() {
        return new IOEvent_js_1.IOEvent("open");
    }
    close(detail) {
        return new IOEvent_js_1.IOEvent("close", { detail });
    }
    error(error) {
        return new IOEvent_js_1.IOEvent("error", { error });
    }
    data(data) {
        return new IOEvent_js_1.IOEvent("data", { data });
    }
    any(data) {
        return new IOEvent_js_1.IOEvent("any", { data });
    }
}
exports.IOEventFactory = IOEventFactory;
class IOEventTarget extends TypedEventTarget_js_1.TypedEventTarget {
...
exports.IOEventTarget = IOEventTarget;
// instance id
